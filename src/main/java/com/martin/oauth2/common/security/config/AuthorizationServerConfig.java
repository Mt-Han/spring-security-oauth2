...
/**
 * @author martin
 * @description authorization server config
 * @since 2023.08.31
 **********************************************************************************************************************/
@Configuration
...
//				.redirectUris(strings -> strings.addAll(Set.of(
//						"http://127.0.0.1:8081/login/oauth2/code/oauth2-client-app",
//						"http://127.0.0.1:8081")))
				.scopes(strings -> strings.addAll(Set.of(
						OidcScopes.OPENID,
						"read",
						 "write")))
